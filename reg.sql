...
-- Zrzut struktury bazy danych reg
CREATE DATABASE IF NOT EXISTS `reg` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `reg`;

-- Zrzut struktury tabela reg.users
